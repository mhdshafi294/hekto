...
const UpperNavbar: React.FC<UpperNavbarProps> = ({ email, phone }) => {
  const { state, dispatch } = useContext(LanguageContext);
  const currenciesStore = useCurrency();

  const currencies = [
    {
      name: "USD",
      action: () => {
        currenciesStore.setUSD();
      },
    },
    {
      name: "EUR",
      action: () => {
        currenciesStore.setEUR();
      },
    },
  ];
  ...
  const languages = [
    {
      name: "Arabic",
      action: () => dispatch({ type: "ARABIC" }),
    },
    {
      name: "English",
      action: () => dispatch({ type: "ENGLISH" }),
    },
  ];
        ...
        <div className="flex justify-between text-zinc-100 h-full">
          <div className="flex justify-start items-center gap-4 text-zinc-100 h-full">
            <div className="flex justify-start items-center gap-2.5 h-full">
              ...
              <p className="text-darkblue">{email}</p>
            </div>
            <div className="flex justify-start items-center gap-2.5 h-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-darkblue">{phone}</p>
            </div>
          </div>
          <div className="flex justify-between items-center gap-4 h-full">
            ...
            />
            <DropDownMenu
              label={currenciesStore.currency}
              items={currencies}
              color="text-zinc-100 "
              bgColor="bg-violet-600"
            />
            ...
            <div
              ...
              "
            >
              <p className="text-zinc-100 text-base text-darkblue mr-0.5">
                Wishlist
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
